    ...
    <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12 p-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 p-0">
                            <div class="row h-50 d-flex align-items-center fw-semibold p-0 m-0">
                                <p class="p-0 m-0">
        ...
        <div class="container top">
            <div class="d-flex justify-content-center">
                <i class="fa-brands fa-instagram m-2 fs-1"></i>
                <i class="fa-brands fa-facebook-f m-2 fs-1"></i>
                <i class="fa-brands fa-twitter m-2 fs-1"></i>
            </div>
            <span class="d-flex justify-content-center fw-bold">@ecommerceart</span>
        </div>
    </div>
