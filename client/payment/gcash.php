...
<div class="container">
    <div class="row top d-flex justify-content-center">
        <h1 class="text-center mb-3">GCash Payment</h1>
        <hr>
            ...
            <div class="col-lg-12 col-xl-6 p-0">
                <form action="confirmation.php" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="form-outline row mb-3">
                        <input type="text" name="gcashname" id="gcashname" class="form-control-lg" placeholder="GCash Name" autocomplete="off" required="required">
                    </div>
                    <!-- Account No. field -->
                    <div class="form-outline row mb-3">
                        <input type="text" name="gcashno" id="gcashno" class="form-control-lg" placeholder="GCash No." autocomplete="off" required="required">
                    </div>
                    <!-- Price field -->
                    <div class="form-outline row mb-3">
