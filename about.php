    ...
    <div class="container-fluid p-0">
            ...
            <div class="container-fluid px-5 pt-3">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fw-semibold">
                        ...
                        <li class="nav-item px-4">
                            <a class="nav-link-about" href="services.php">SERVICES</a>
                        </li>
                        <li class="nav-item px-4">
                            <a class="nav-link-about nav-link-contact" href="contact.php">CONTACT</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="about-page">
            <div class="content-container">
                ...
                <p class="justified-text">We also provide affordable and amazing artworks to our customers; To sell newly created craft with love by Artists that will fulfill customers satisfaction; To give reasonable price and meaningful products to our customers. Practice professionalism, competitiveness and consideration at all.</p>
            </div>
        </div>
